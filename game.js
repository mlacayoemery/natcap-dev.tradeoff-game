...
var example = function() {
    var farm_values = [[12,14],[21,10],[28,2], [3,24]];
    ...
    var ranch_values = [[28,2],[13,18],[10,18], [5,17]];
...
var calculate = function () {
    ...
    var concat_pairs = function(p_array){
        ...
        var board_width = pts_crop_ag.length, board_length = pts_crop_ag[0].length;
    ...
    for (var pair_index = 0; pair_index < r_pairs.length; pair_index++){
        ...
        r_total += pts_past_ps[x][y];
    }   
    document.getElementById("r_total").value = ag_total;
